...
//   useEffect(() => {
//     fetch(`https://assignment-server-red.vercel.app/books/${id}`)
//       .then(res => res.json())
//       .then(data => {
//         setBook(data.result);
//         console.log(data);
...
//         <div className="bg-black bg-opacity-40 backdrop-blur-xl rounded-3xl shadow-2xl border border-purple-500 border-opacity-30 overflow-hidden 
//                         transform hover:scale-105 transition-all duration-700 hover:shadow-purple-500 hover:shadow-2xl">
          
//           {/* Header with Cover & Gradient Overlay */}
...
//             {/* Genre Badge */}
//             <div className="absolute bottom-6 left-6 bg-linear-to-r from-pink-500 to-purple-600 text-white px-6 py-3 rounded-full text-lg font-bold shadow-2xl 
//                               animate-slide-in-left border-2 border-white border-opacity-30">
//               #{book.genre}
//             </div>
//           </div>
...
//             <h1 className="text-5xl font-extrabold mb-3 bg-clip-text text-transparent bg-linear-to-r from-pink-500 via-purple-500 to-cyan-500 
//                             animate-gradient-x">
//               {book.title}
//             </h1>
...
//                     await fetch("https://assignment-server-red.vercel.app/comments", {
//                       method: "POST",
...
//               <button className="relative group overflow-hidden bg-linear-to-r from-pink-600 via-purple-600 to-cyan-600 
//                                 text-white font-bold text-xl py-5 px-12 rounded-full shadow-2xl 
...
//       const res = await fetch(`https://assignment-server-red.vercel.app/comments/${bookId}`);

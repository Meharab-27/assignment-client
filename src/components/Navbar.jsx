...
//             <div className="navbar bg-white/70 backdrop-blur-md shadow-lg border border-white/30 rounded-full px-6 py-3 transition-all duration-300 hover:shadow-xl">
...
//                             tabIndex={0}
//                             role="button"
//                             className="btn btn-ghost md:hidden hover:bg-purple-100 text-purple-600"
//                         >
//                             <svg
...
//                         <ul
//                             tabIndex="-1"
//                             className="menu menu-sm dropdown-content bg-white/90 backdrop-blur-md rounded-xl mt-3 w-52 p-3 shadow-lg border border-gray-200"
//                         >
//                             <li>
//                                 <NavLink
//                                     to="/"
...
//                             <img
//                                 className="w-11 h-11 rounded-full border-2 border-purple-400 shadow-md cursor-pointer hover:scale-105 transition-transform"
//                                 src={user.photoURL || ''}
//                                 alt={user.displayName || 'User'}
//                             />
//                             <span className="absolute bottom-14 left-1/2 -translate-x-1/2 bg-purple-700 text-white text-xs px-2 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
...
//                         <button
//                             onClick={signOutUser}
//                             className="bg-linear-to-r from-purple-600 to-pink-500 text-white px-6 py-2 rounded-full font-semibold hover:opacity-90 transition"
//                         >
//                             Log Out
//                         </button>
//                     ) : (
...
//                             <Link
//                                 to="/auth/register"
//                                 className="bg-white text-purple-600 border-2 border-purple-500 px-6 py-2 rounded-full font-semibold hover:bg-purple-50 transition"
//                             >
//                                 Register
//                             </Link>
//                         </>
